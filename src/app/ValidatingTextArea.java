...
/**
 * Wrapper for javaFX TextArea exactly the same but implements
 ...
 */
public class ValidatingTextArea extends TextArea implements IValidates{
    ...
    public ValidatingTextArea(String tableName, String columnName) {
        super();
